...
const notice = ref<Partial<NoticeInfo>>({
  title: '',
  content: '',
  pick: false
})
...
const submitNotice = async () => {
  ...
  try {
    ...
    const response = await $fetch('/api/help/notice', {
      method: 'POST',
      body: {
        title: notice.value.title.trim(),
        content: notice.value.content.trim(),
        pick: notice.value.pick || false
      }
    })
